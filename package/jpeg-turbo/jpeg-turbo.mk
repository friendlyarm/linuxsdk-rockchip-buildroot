...
ifeq ($(BR2_PACKAGE_JPEG_TURBO_JPEG8),y)
JPEG_TURBO_CONF_OPTS = -DWITH_JPEG8=ON
else ifeq ($(BR2_PACKAGE_JPEG_TURBO_JPEG7),y)
JPEG_TURBO_CONF_OPTS = -DWITH_JPEG7=ON
endif

ifneq ($(BR2_STATIC_LIBS)$(BR2_PACKAGE_JPEG_TURBO_STATIC),)
